module controller_io(
		     ...
		     input wire 	DATA, ACK,
		     output wire 	err,
		     output wire 	COMMAND, ATT, 
		     output wire 	c_clk,
		     output wire 	SLCT, STRT, UP, RGHT, DOWN, LEFT,
		     output wire 	L1, L2, R1, R2, TRI, SQU, XXX, CIR,
		     output wire [7:0] RJOY_X, RJOY_Y, LJOY_X, LJOY_Y,
		     output wire 	RJOY, LJOY
		     );
