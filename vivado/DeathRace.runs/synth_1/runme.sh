...
HD_PWD='C:/Users/Mateusz/Documents/GitHub/uec2_DeathRace/vivado/DeathRace.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_controller.tcl
