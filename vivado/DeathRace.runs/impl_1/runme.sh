...
HD_PWD='C:/Users/Mateusz/Documents/GitHub/uec2_DeathRace/vivado/DeathRace.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_controller.tcl -notrace
