...
set rc [catch {
  ...
  add_files -quiet C:/Users/Mateusz/Documents/GitHub/uec2_DeathRace/vivado/project_1/project_1.runs/synth_1/vga_example.dcp
...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file vga_example_control_sets_placed.rpt"
