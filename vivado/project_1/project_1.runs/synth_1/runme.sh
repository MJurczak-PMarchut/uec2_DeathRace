...
HD_PWD='C:/Users/Mateusz/Documents/GitHub/uec2_DeathRace/vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_example.tcl
