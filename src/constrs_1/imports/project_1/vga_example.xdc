...
set_property PACKAGE_PIN V16 [get_ports C_DATA]					
	set_property IOSTANDARD LVCMOS33 [get_ports C_DATA]
set_property PACKAGE_PIN W16 [get_ports C_ACK]					
	set_property IOSTANDARD LVCMOS33 [get_ports C_ACK]
set_property PACKAGE_PIN W17 [get_ports C_COMMAND]					
	set_property IOSTANDARD LVCMOS33 [get_ports C_COMMAND]
set_property PACKAGE_PIN W15 [get_ports C_ATT]					
	set_property IOSTANDARD LVCMOS33 [get_ports C_ATT]
set_property PACKAGE_PIN V15 [get_ports C_CLK_OUT]					
	set_property IOSTANDARD LVCMOS33 [get_ports C_CLK_OUT]
...
set_property PACKAGE_PIN W19 [get_ports BW]						
	set_property IOSTANDARD LVCMOS33 [get_ports BW]
